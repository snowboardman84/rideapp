...
export default class Beaver extends Component {
    constructor() {
        super()
        this.state = {
            data: {
    ...
    componentDidMount() {
        axios.get("http://api.openweathermap.org/data/2.5/weather?lat=44.91583&lon=-111.35583&APPID=deb29dfd065c544e4164e76b251706d3").then((response) => {
    ...
    render() {
        return (
            ...
            <div>
                <Card className="card">
                    <CardBody>
                        <CardTitle className="cardtitle">Beaver Creek Cabin</CardTitle>
                    </CardBody>
                    <img width="30%" src="https://www.recreation.gov/webphotos/NRSO/pid75232/0/540x360.jpg" alt="Card image cap" />
                    <CardBody>
                        <CardText>Your weather for Beaver Creek Cabin for today is {this.state.data.weather[0].description}. <br />
                        ...
                        <CardLink href="https://www.fs.usda.gov/recarea/custergallatin/recarea/?recid=5637">Beaver Creek Cabin</CardLink>
                    </CardBody>
                </Card>
            </div>
        )
