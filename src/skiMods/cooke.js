...
export default class Cooke extends Component {
    constructor() {
        super()
        this.state = {
            data: {
    ...
    componentDidMount() {
        axios.get("http://api.openweathermap.org/data/2.5/weather?lat=45.0160&lon=-109.9166&APPID=deb29dfd065c544e4164e76b251706d3").then((response) => {
    ...
    render() {
        return (
            ...
            <div>
                <Card className="card">
                    <CardBody>
                        <CardTitle className="cardtitle">Cooke City Backcountry</CardTitle>
                    </CardBody>
                    <img width="30%" src="https://static.rootsrated.com/image/upload/s--Io-Vsp8C--/t_rr_large_natural/g9ribin32q7c5rab4x5y.jpg" alt="Card image cap" />
                    <CardBody>
                        <CardText>Your weather for Cooke City Backcountry for today is {this.state.data.weather[0].description}. <br />
                        ...
                        <CardLink href="https://www.beartoothpowder.com/">Beartooth Powder Guides</CardLink>
                    </CardBody>
                </Card>
            </div>
        )
