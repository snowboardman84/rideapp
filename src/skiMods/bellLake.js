...
export default class Bell extends Component {
    ...
    componentDidMount() {
        axios.get("http://api.openweathermap.org/data/2.5/weather?lat=45.5388&lon=-111.9966&APPID=deb29dfd065c544e4164e76b251706d3").then((response) => {
    ...
    render() {
        return (
            ...
            <div>
                <Card className="card">
                    <CardBody>
                        <CardTitle className="cardtitle">Bell Lake Yurt</CardTitle>
                    </CardBody>
                    <img width="30%" src="https://static1.squarespace.com/static/536406a6e4b087e75b092d96/t/5411ebe5e4b0c2b5f99707b5/1410460647177/Branham+Peak+bookcase+couloirs.?format=2500w" alt="Card image cap" />
                    <CardBody>
                        <CardText>Your weather for Bell Lake Yurt for today is {this.state.data.weather[0].description}. <br />
                        ...
                        <CardLink href="http://belllakeyurt.com">Bell Lake Yurt</CardLink>
                    </CardBody>
                </Card>
            </div>
        )
