...
export default class BigSky extends Component {
    constructor() {
        super()
        this.state = {
            data: {
    ...
    componentDidMount() {
        axios.get("http://api.openweathermap.org/data/2.5/weather?lat=45.2618&lon=-111.3080&APPID=deb29dfd065c544e4164e76b251706d3").then((response) => {
    ...
    render() {
        return (
            ...
            <div>
                <Card className="card">
                    <CardBody>
                        <CardTitle className="cardtitle">Big Sky Resort</CardTitle>
                    </CardBody>
                    <img width="30%" src="http://photos3.meetupstatic.com/photos/event/8/4/f/4/600_453394036.jpeg" alt="Card image cap" />
                    <CardBody>
                        <CardText>Your weather for Big Sky Resort for today is {this.state.data.weather[0].description}. <br />
                        ...
                        <CardLink href="http://bigskyresort.com">Big Sky Resort</CardLink>
                    </CardBody>
                </Card>
            </div>
        )
