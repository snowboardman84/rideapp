...
export default class RedLodge extends Component {
    constructor() {
        super()
        this.state = {
            data: {
    ...
    componentDidMount() {
        axios.get("http://api.openweathermap.org/data/2.5/weather?lat=45.1908&lon=-109.3364&APPID=deb29dfd065c544e4164e76b251706d3").then((response) => {
    ...
    render() {
        return (
            ...
            <div>
                <Card className="card">
                    <CardBody>
                        <CardTitle className="cardtitle">Red Logde Mountain</CardTitle>
                    </CardBody>
                    <img width="30%" src="https://www.redlodgemountain.com/wp-content/uploads/trail-map-web-large.jpg" alt="Card image cap" />
                    <CardBody>
                        <CardText>Your weather for Red Logde Resort for today is {this.state.data.weather[0].description}. <br />
                        ...
                        <CardLink href="http://redlodgemountain.com">Red Logde Mountain</CardLink>
                    </CardBody>
                </Card>
            </div>
        )
