    ...
    render() {
        return (
            <div>
                <Card className="card">
                    <CardBody>
                        <CardTitle className="cardtitle">Red Lodge Mountain</CardTitle>
                    </CardBody>
                    <img width="30%" src="https://www.redlodgemountain.com/wp-content/uploads/trail-map-web-large.jpg" alt="Card image cap" />
                    <CardBody>
                        <CardText>Your weather for Red Lodge Resort for today is {this.state.data.weather[0].description}. <br />
                        ...
                        <CardLink href="http://redlodgemountain.com">Red Lodge Mountain</CardLink>
                    </CardBody>
                </Card>
            </div>
        )
