...
export default class Bridger extends Component {
    ...
    componentDidMount() {
        axios.get("http://api.openweathermap.org/data/2.5/weather?lat=45.8174&lon=-110.8966&APPID=deb29dfd065c544e4164e76b251706d3").then((response) => {
    ...
    render() {
        return (
            ...
            <div>
                <Card className="card">
                    <CardBody>
                        <CardTitle className="cardtitle">Bridger Bowl</CardTitle>
                    </CardBody>
                    <img width="30%" src="https://bridgerbowl.com/img/content/bridger-bowl-full--2x.jpg" alt="Card image cap" />
                    <CardBody>
                        ...
                        <CardLink href="http://bridgerbowl.com">Bridger Bowl</CardLink>
                    </CardBody>
                </Card>
            </div>
        )
